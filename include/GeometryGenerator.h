...
// Added DirectX:: to ensure that the scope of all the DirectXMath types are resolved (Rohit S, 2014-02-10)
...
public:
	...
	{
		Vertex(){}
		Vertex(const DXVector3& p, const DXVector3& n, const DXVector3& t, const DXVector2& uv)
