// Source file of the DXChildApp class. This is just a template which can be used by making a copy of this file and then renaming the class.

#include "DXChildApp.h"

// param ctor
// TODO: Initialize additional members as necessary
DXChildApp::DXChildApp(HINSTANCE hInstance, const std::string strSceneFilePath) : DXApp(hInstance, strSceneFilePath)
{
}

// dtor
DXChildApp::~DXChildApp()	{}

// initializes the DirectX application's objects and resources
void DXChildApp::initApp()
{
	DXApp::initApp();
...
void DXChildApp::updateScene(float dt)
{
...
void DXChildApp::moveCamera(float dt)
{
...
void DXChildApp::OnMouseDown(WPARAM btnState, int x, int y)	// {}
{
...
void DXChildApp::OnMouseUp(WPARAM btnState, int x, int y) // {}
{
	// release the D3D window from capturing mouse events
	ReleaseCapture();
}

void DXChildApp::OnMouseMove(WPARAM btnState, int x, int y)
{
