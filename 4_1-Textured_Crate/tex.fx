...
SamplerState gTriLinearSam
{
	...
	// assign a border colour
	BorderColor = float4(1.0f,0.0f,1.0f,1.0f);
};
...
float4 PS(VS_OUT pIn) : SV_Target
{
	...
	float4 diffuseAlpha = gDiffuseMap2.Sample( gTriLinearSam, pIn.texC );
	float4 diffuse = diffuseRGB; // * diffuseAlpha;
